...
const TextEditor = ({
  ...
  return (
    <div className="mx-auto p-4">
      <div className="flex flex-wrap gap-4 space-x-2 rounded-t-md border border-gray-300 p-2">
        <select
      ...
      <div
        ...
        className="min-h-[200px] rounded-b-md border border-gray-300 p-4 focus:outline-none"
