          ...
          <div className="relative mt-4 flex h-[540px]">
            <div className="flex flex-col">
              {[
                ...
                <div
                  key={idx}
                  className="mt-1 h-[60px] border-b-2 border-dashed py-2 pr-4 text-right"
                >
                  {time}
                </div>
              ))}
                ...
                {scheduleData
                  ...
                  .map((event, idx) => {
                    ...
                    return (
                      <div
                        key={idx}
                        className="border-borderPrimary-4 absolute left-0 right-0 mx-2 rounded-lg border-l border-primary bg-thead p-4 text-primary"
