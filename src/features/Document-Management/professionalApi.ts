...
export const professionalApi = createApi({
    ...
    endpoints: builder => ({
        getAllProfessionals: builder.query({
            query: () => "/api/v1/management/certificate/professional-development/all?size=1000000&page=0",
        }),
        //
        ...
        getProfessionalById: builder.query({
            query: id => `/api/v1/management/certificate/professional-development/${id}`,
        }),
        //
