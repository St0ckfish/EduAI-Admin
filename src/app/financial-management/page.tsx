...
const FeesManagement = () => {
    ...
    return ( 
        ...
        <div className="flex items-center gap-1 lg:ml-[290px] mt-12 ml-7">
            ...
            <Link className="text-[#526484] hover:text-blue-400 hover:underline text-[18px] font-semibold" href="/financial-management">Financial Management</Link>
        </div>
            <div className="lg:ml-[270px] mr-[5px] relative mt-10 overflow-x-auto bg-transparent sm:rounded-lg h-screen">
                ...
                <div className="flex justify-left gap-5 text-[23px] font-bold mb-5 ml-4">
                    ...
                    <Link href="/financial-management/scholarship">
                    Scholarship
                    </Link>
                </div>
