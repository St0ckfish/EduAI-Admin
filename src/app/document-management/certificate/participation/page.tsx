                        ...
                        {data?.data.content.filter((participation: Participation) => {
                            ...
                            <tr key={participation.id} className="bg-white border-b  hover:bg-gray-50">
                                ...
                                <th scope="row" className="px-6 py-4 whitespace-nowrap">
                                    <p> {participation.title_en} </p>
                                </th>
                                <td className="px-6 py-4 whitespace-nowrap">
                                {participation.id}
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                {participation.content_en}
                                </td>
                                <td className="flex gap-2 px-6 py-4 whitespace-nowrap">
                                {participation.attachments.map((img:any, index:number) => (
                                    <img className="w-[200px] rounded-md" src={img.viewLink} alt="#" key={index} />
                                 ))}
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <Link href={`/document-management/participation/${participation.id}`} className="font-medium text-blue-600 hover:underline">edit</Link>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
