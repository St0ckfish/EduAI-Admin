...
import { useGetAllAllPostsQuery } from "@/features/communication/postApi";
...
const News = () => {
    ...
    const { data, error, isLoading } = useGetAllAllPostsQuery(null);
    useEffect(() => {
    ...
    return (
        ...
        >
            <div className="p-9 rounded-xl bg-white grid justify-center items-center w-full h-full gap-4">
            {data?.data.content.map((post: Post, index:number) => (
                <div key={post.id} className="grid p-4 border border-[#ebebeb] rounded-xl w-[800px]">
                    <div className="flex justify-between w-full gap-8">
                        <div className="flex gap-1 items-center">
                            ...
                            <div className="grid font-semibold text-[14px]">
                        ...
                        <div className="flex gap-2 items-start">
                            {
                                open === index ? (
                                    <div className="flex bg-white h-[35px] px-1.5 py-1 items-center rounded-full gap-2">
                                        ...
                                        <Link href={`/course/course-management`}>
                    ...
                    <div className="mt-2 font-semibold ml-2">
                        <p>{post.content}</p>
                    </div>
                    <div className="flex justify-center mt-2">
                        <div className="flex justify-right mt-2 flex-wrap">
                            {post.attachments.map((img:any, index:number) => (
                                <img className="w-[300px] rounded-md" src={img.viewLink} alt="#" key={index} />
                            ))}
                        </div>
                    </div>
                    ...
                    <div className=" border-[#65676b] border-y-2 flex gap-10 items-center py-3 font-semibold text-[#65676b] px-2 justify-center">
