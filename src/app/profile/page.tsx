...
import { useUpdateCurrentUserMutation, useUpdatePictureMutation } from "@/features/User-Management/employeeApi";
...
const Profile = () => {
  ...
  const { data: userData, isLoading: userLoading, refetch } =
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid h-full w-full rounded-xl bg-bgPrimary p-7">
            ...
            <div className="text-semibold flex h-full w-full rounded-xl justify-between bg-bgPrimary p-5">
              ...
              <div className="flex items-center">
                ...
                <label className="cursor-pointer">
                  <FaCamera className="text-gray-500 translate-x-10 translate-y-2" />
                ...
                <span className="grid font-semibold">
                  ...
                  <p>
                    {currentLanguage === 'ar'
                      ...
                      ? 'ID :'
                      : 'ID:'}{' '}
                    <span className="text-textSecondary">{userData.data?.id}</span>
                  </p>
                </span>
            ...
            <div className="text-semibold mt-5 flex h-full w-full rounded-xl border-2 border-borderPrimary bg-bgPrimary p-5">
              ...
              <label
                htmlFor="regionId"
                className="grid font-sans text-[18px] font-semibold w-[400px] max-[471px]:w-[350px]"
              >
                {currentLanguage === "en"
                  ? "Region Id"
                  : currentLanguage === "ar"
