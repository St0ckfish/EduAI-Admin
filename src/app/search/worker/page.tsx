...
import { useGetAllWorkersQuery, useGetWorkerByIdQuery } from "@/features/User-Management/workerApi";
...
const WorkerSearch = () => {
    ...
    const { data: EmployeeQ, isLoading: isEmployee } = useGetWorkerByIdQuery(selectedId, {
        skip: !selectedId,
    });
            ...
            <div className="flex w-full h-full justify-center p-2 overflow-auto">
                <div className="grid bg-white rounded-xl w-full h-full overflow-auto ">
                    <div className="flex gap-2 bg-gray-200 h-[70px] rounded-t-xl items-center pl-3 font-semibold overflow-auto">
                        ...
                        <Link className="text-blue-500 underline underline-offset-4" href="/search/worker">Worker</Link>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 p-7">
                        <div className="grid p-4">
                            ...
                            <div className="mt-3">
                                    <p className="font-semibold">{filteredStudents.length} Workers Found</p>
                                </div>
                                    ...
                                    isEmployee ? <Spinner /> :
                                        <div className="grid justify-center items-center mt-16">
                                            ...
                                            <div className="justify-end flex">
                                                <Link className=" px-2 py-1 rounded-lg bg-[#3E5AF0] hover:bg-[#4a5cc5] hover:shadow-xl text-white ease-in font-semibold duration-300" href={`/worker/view-worker/${EmployeeQ.data.id}`}>View</Link>
                                            </div>
