...
import {  useGetAllTeachersQuery, useGetTeacherByIdQuery } from "@/features/User-Management/teacherApi";
...
const TeahcerSearch = () => {
    ...
    const { data: EmployeeQ, isLoading: isEmployee } = useGetTeacherByIdQuery(selectedId, {
        skip: !selectedId,
    });
                                    ...
                                    isEmployee ? <Spinner /> :
                                        <div className="grid justify-center items-center ">
                                            ...
                                            <div className="justify-end flex">
                                                <Link className=" px-2 py-1 rounded-lg bg-[#3E5AF0] hover:bg-[#4a5cc5] hover:shadow-xl text-white ease-in font-semibold duration-300" href={`/teacher/view-teacher/${EmployeeQ.data.id}`}>View</Link>
                                            </div>
                                            <div className="grid justify-center text-center items-center mb-4">
