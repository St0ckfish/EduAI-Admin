...
const AddNewParent = () => {
    ...
    const onSubmit = async (data: any) => {
        ...
        // Append file inputs
        if (data.parentIdPhoto[0]) formData.append('parentIdPhoto', data.parentIdPhoto[0]);
        if (data.studentIdPhoto[0]) formData.append('studentIdPhoto', data.studentIdPhoto[0]);
        if (data.studentProfilePhoto[0]) formData.append('studentProfilePhoto', data.studentProfilePhoto[0]);
        if (data.studentCertificatesOfAchievement[0]) formData.append('studentCertificatesOfAchievement', data.studentCertificatesOfAchievement[0]);
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="grid p-10 bg-white rounded-xl items-center justify-center xl:w-[1000px] lg:w-[750px] my-10 gap-5 md:w-[600px] sm:w-[500px]">
                    ...
                    <div className="grid grid-cols-2 gap-4 max-[1278px]:grid-cols-1">
                        ...
                        school Id
                            <input id="schoolId" type="schoolId" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("schoolId", { required: true })} />
                            {errors.schoolId && <span className="text-red-600">This field is required</span>}
                        </label>
                    </div>
                    <div className="grid grid-cols-2 gap-4 max-[1278px]:grid-cols-1">
                        {/* Input fields for student information */}
                        <label htmlFor="student_username" className="grid text-[18px] font-sans font-semibold">
                            Student Username
                            <input id="student_username" type="text" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("student_username", { required: true })} />
                            {errors.student_username && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="student_email" className="grid text-[18px] font-sans font-semibold">
                            Student Email
                            <input id="student_email" type="email" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("student_email", { required: true })} />
                            {errors.student_email && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="student_password" className="grid text-[18px] font-sans font-semibold">
                            Student Password
                            <input id="student_password" type="password" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("student_password", { required: true })} />
                            {errors.student_password && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="student_nid" className="grid text-[18px] font-sans font-semibold">
                            Student NID
                            <input id="student_nid" type="number" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("student_nid", { required: true })} />
                            {errors.student_nid && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="student_gender" className="grid text-[18px] font-sans font-semibold">
                            Student Gender
                            <select id="student_gender" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("student_gender", { required: true })}>
                                <option value="">Select gender</option>
                                <option value="MALE">Male</option>
                                <option value="FEMALE">Female</option>
                            </select>
                            {errors.student_gender && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="student_birthDate" className="grid text-[18px] font-sans font-semibold">
                            Student Date Of Birth
                            <input id="student_birthDate" type="date" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("student_birthDate", { required: true })} />
                            {errors.student_birthDate && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="student_name_en" className="grid text-[18px] font-sans font-semibold">
                            Student Name EN
                            <input id="student_name_en" type="text" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("student_name_en", { required: true })} />
                            {errors.student_name_en && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="student_name_ar" className="grid text-[18px] font-sans font-semibold">
                            Student Name AR
                            <input id="student_name_ar" type="text" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("student_name_ar", { required: true })} />
                            {errors.student_name_ar && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="student_name_fr" className="grid text-[18px] font-sans font-semibold">
                            Student Name FR
                            <input id="student_name_fr" type="text" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("student_name_fr", { required: true })} />
                            {errors.student_name_fr && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="student_about" className="grid text-[18px] font-sans font-semibold">
                            Student About
                            <input id="student_about" type="text" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("student_about", { required: true })} />
                            {errors.student_about && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="relationshipToStudent" className="grid text-[18px] font-sans font-semibold">
                            Relationship To Student
                            <input id="relationshipToStudent" type="text" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("relationshipToStudent", { required: true })} />
                            {errors.relationshipToStudent && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="studyLevel" className="grid text-[18px] font-sans font-semibold">
                            Study Level
                            <input id="studyLevel" type="text" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("studyLevel", { required: true })} />
                            {errors.studyLevel && <span className="text-red-600">This field is required</span>}
                        </label>
                        <label htmlFor="eduSystemId" className="grid text-[18px] font-sans font-semibold">
                        edu System Id
                            <input id="eduSystemId" type="eduSystemId" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("eduSystemId", { required: true })} />
                            {errors.eduSystemId && <span className="text-red-600">This field is required</span>}
                        </label>
                      <label htmlFor="parentIdPhoto" className="grid text-[18px] font-sans font-semibold">
                          Parent ID Photo
                          <input id="parentIdPhoto" type="file" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("parentIdPhoto")} />
                      </label>
                    </div>
                    {/* File input fields */}
                    <div className='grid grid-cols-2 gap-4 max-[1278px]:grid-cols-1'>
                      <label htmlFor="studentIdPhoto" className="grid text-[18px] font-sans font-semibold">
                          Student ID Photo
                          <input id="studentIdPhoto" type="file" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("studentIdPhoto")} />
                      </label>
                      <label htmlFor="studentProfilePhoto" className="grid text-[18px] font-sans font-semibold">
                          Student Profile Photo
                          <input id="studentProfilePhoto" type="file" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("studentProfilePhoto")} />
                      </label>
                      <label htmlFor="studentCertificatesOfAchievement" className="grid text-[18px] font-sans font-semibold">
                          Student Certificates Of Achievement
                          <input id="studentCertificatesOfAchievement" type="file" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" {...register("studentCertificatesOfAchievement")} />
                      </label>
                    </div>
