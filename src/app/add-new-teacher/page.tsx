  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      toast.success('Teacher created successfully');
        ...
        toast.error('Failed to create Teacher:  you may enter the passord incorrectly');
    }
  };
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid p-10 bg-white rounded-xl items-center justify-center xl:w-[1000px] lg:w-[750px] my-10 gap-5 md:w-[600px] sm:w-[500px]">
          <div className="flex items-center justify-start gap-2">
            ...
            <h1 className="text-[22px] font-sans font-semibold">Teacher Information</h1>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 max-[1278px]:grid-cols-1">
            ...
            <label htmlFor="subject" className="grid items-center text-[18px] font-sans font-semibold mt-4">
                <select defaultValue="" id="subject" {...register("subject", { required: true })} className="w-[400px] h-[55px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]">
                ...
                {errors.subject && <span className="text-[#e81123] text-[18px]">Qualification is Required</span>}
            </label>
