        ...
        <div className="flex justify-between text-center max-[502px]:grid max-[502px]:justify-center">
          ...
          <div className="flex justify-center">
            <Link
              ...
              className="mx-3 mb-5 w-[200px] whitespace-nowrap rounded-xl bg-primary px-4 py-2 text-[18px] font-semibold text-white duration-300 ease-in hover:bg-hover hover:shadow-xl"
            >
              {currentLanguage === "ar"
                ? "+ إضافة معلم جديد"
                : currentLanguage === "fr"
