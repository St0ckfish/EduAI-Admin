                        ...
                        <form className="grid gap-2" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            >
                                <Tabs.List className="shrink-0 flex gap-4 mb-2" aria-label="Manage your account">
                                    <Tabs.Trigger
                                        className="bg-white px-5 h-[45px] flex-1 border-b flex items-center justify-center text-[15px] font-sans font-semibold"
                                        value="tab1"
                                    >
                                        Step 1
                                    </Tabs.Trigger>
                                ...
                                >
                                    <div className="grid grid-cols-2 gap-3">
                                        <label htmlFor="username" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your Username
                                            <input id="username" {...register("username", { required: true })} placeholder="Enter Your username" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.username ? "border-[#d74f41]" : "border-zinc-300"}  outline-none `} type="text" />
                                        ...
                                        <label htmlFor="email" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your Email
                                            <input id="email" {...register("email", { required: true })} placeholder="Enter Your email" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.email ? "border-[#d74f41]" : "border-zinc-300"}  outline-none `} type="email" />
                                        ...
                                        <label htmlFor="password" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your Password
                                            <input id="password" {...register("password", { required: true })} placeholder="Enter Your password" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.password ? "border-[#d74f41]" : "border-zinc-300"}  outline-none `} type="password" />
                                        ...
                                        <label htmlFor="nid" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your NID
                                            <input id="nid" {...register("nid", { required: true })} placeholder="Enter Your NID" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.nid ? "border-[#d74f41]" : "border-zinc-300"}  outline-none `} type="number" />
                                        ...
                                        <label htmlFor="regionId" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your regionId
                                            <input id="regionId" {...register("regionId", { required: true })} placeholder="Enter Your NID" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.regionId ? "border-[#d74f41]" : "border-zinc-300"}  outline-none `} type="number" />
                                        ...
                                        <label htmlFor="gender" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your Gender
                                            <select defaultValue="" id="gender" {...register("gender", { required: true })} className={`border ${errors.gender ? "border-[#d74f41]" : "border-zinc-300"} text-[#9a9a9a] text-sm outline-none rounded-xl w-[250px] h-full py-3 px-4 `}>
                                        ...
                                        <label htmlFor="religion" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your Religion
                                            <select defaultValue="" id="religion" {...register("religion", { required: true })} className={`border ${errors.religion ? "border-[#d74f41]" : "border-zinc-300"} text-[#9a9a9a] text-sm outline-none  w-[250px] rounded-xl h-full py-3 px-4 `}>
                                        ...
                                        <label htmlFor="number" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your number
                                            <input id="number" {...register("number", { required: true })} placeholder="Enter Your number" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.number ? "border-[#d74f41]" : "border-zinc-300"}  outline-none `} type="number" />
                                ...
                                >
                                    <div className="grid grid-cols-2 gap-3">
                                        <label htmlFor="nationality" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your Nationality
                                            <select defaultValue="" id="nationality" {...register("nationality", { required: true })} className={`border ${errors.nationality ? "border-[#d74f41]" : "border-zinc-300"} text-[#9a9a9a] text-sm outline-none rounded-lg w-[250px] h-full py-3 px-4 `}>
                                        ...
                                        <label htmlFor="employeeType" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Employee Type
                                            <select defaultValue="" id="religion" {...register("employeeType", { required: true })} className={`border ${errors.employeeType ? "border-[#d74f41]" : "border-zinc-300"} text-[#9a9a9a] text-sm outline-none  w-[250px] rounded-xl h-full py-3 px-4 `}>
                                                <option selected value="">Select religion </option>
                                        ...
                                        Qualification
                                            <select defaultValue="" id="qualification" {...register("qualification", { required: true })} className={`border ${errors.qualification ? "border-[#d74f41]" : "border-zinc-300"} text-[#9a9a9a] text-sm outline-none  w-[250px] rounded-xl h-full py-3 px-4 `}>
                                                <option selected value="">Select religion </option>
                                        ...
                                        <label htmlFor="birthDate" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your birthDate
                                            <input id="birthDate" {...register("birthDate", { required: true })} placeholder="Enter Your NID" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.birthDate ? "border-[#d74f41]" : "border-zinc-300"}  outline-none `} type="date" />
                                        ...
                                        <label htmlFor="name_en" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your English Name
                                            <input id="name_en" {...register("name_en", { required: true })} placeholder="Enter Your English Name" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.name_en ? "border-[#d74f41]" : "border-zinc-300"}  outline-none max-[471px]:w-[350px]`} type="text" />
                                        ...
                                        <label htmlFor="name_ar" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your Arabic Name
                                            <input id="name_ar" {...register("name_ar", { required: true })} placeholder="Enter Your Arabic Name" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.name_ar ? "border-[#d74f41]" : "border-zinc-300"}  outline-none max-[471px]:w-[350px]`} type="text" />
                                        ...
                                        <label htmlFor="name_fr" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your French Name
                                            <input id="name_fr" {...register("name_fr", { required: true })} placeholder="Enter Your French Name" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.name_fr ? "border-[#d74f41]" : "border-zinc-300"}  outline-none max-[471px]:w-[350px]`} type="text" />
                                        ...
                                        <label htmlFor="schoolId" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold">
                                            Your schoolId
                                            <input id="schoolId" {...register("schoolId", { required: true })} placeholder="Enter Your schoolId" className={`w-[250px] py-3 px-4 rounded-xl border ${errors.schoolId ? "border-[#d74f41]" : "border-zinc-300"}  outline-none max-[471px]:w-[350px]`} type="number" />
                                            {errors.username && <span className="text-[#e81123] text-[13px]">schoolId is Required</span>}
                                        </label>
                                    </div>
                                    <div className="flex justify-center w-full">
                                        <label htmlFor="about" className="grid text-[#9a9a9a] text-start text-[15px] font-sans font-semibold w-full">
                                            Your about
                                            <textarea id="about" {...register("about", { required: true })} placeholder="Enter Your about" className={`w-full py-3 px-4 rounded-xl border ${errors.about ? "border-[#d74f41]" : "border-zinc-300"}  outline-none max-[471px]:w-[350px]`}/>
