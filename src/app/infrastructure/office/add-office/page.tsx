                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="grid p-10 bg-white rounded-xl items-center justify-center xl:w-[1000px] lg:w-[750px] gap-5 md:w-[600px] sm:w-[500px]">
                        ...
                        <div className="grid grid-cols-2 gap-4 max-[1278px]:grid-cols-1">
                            ...
                            Office Name
                                <input id="labName" {...register("officeName", { required: true })}  type="text" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" />
                            ...
                            Office Type
                                <input id="labType" {...register("officeType", { required: true })}  type="text" className="w-[400px] py-3 px-4 rounded-xl border border-zinc-300 outline-none max-[471px]:w-[350px]" />
