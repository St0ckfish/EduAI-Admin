...
import { useUpdateClasssMutation, useGetClassByIdQuery } from "@/features/Infrastructure/classApi";
...
const EditClass: React.FC<ViewDriverProps> = ({params}) => {
  ...
  const { data: classs, isLoading: isgetting } = useGetClassByIdQuery(params.classId);
